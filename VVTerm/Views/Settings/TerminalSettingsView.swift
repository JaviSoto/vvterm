...
private struct ThemePickerScreen: View {
    let title: String
...
private struct ThemePickerTerminalPreview: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("restty@prod-web-01:~$ ./deploy --env prod")
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.flexible(minimum: 20), spacing: 5), count: 8), spacing: 5) {
